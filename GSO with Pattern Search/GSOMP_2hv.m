function [ fbestvals, bestmembers, archiveNew, fvaluesNew, fvaluesAll, archiveAll,hv,hvcounts] = GSOMP_2hv(fname, ...
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Last modified in 2019-11-20 by Chaofan Yu, Guangxi University
% 1. use "GSO+hookejeeves" algorithm to search the Pareto front
...
load('wind_data.mat'); %内含 Posibility,Wind_P,Wind_Q,final,initial
clear final initial
